...
<h3 align = "center">NISO, or Noirvaze's Immersive Sounds Overhaul, is a sound overhaul, completely changing all audio to a realistic version. Having inspiration from both Java mods, named Presence Foosteps, Sounds and Quality Sounds. since there isnt that many great audio overhaul mods on Bedrock, and its unfair where Java has way better mods than Bedrock, so I decided to make NISO!</h3>
...
```mermaid
graph TD;
    find-footstep-audio-for-each-topic-->wood;
find-footstep-audio-for-each-topic-->grass;
find-footstep-audio-for-each-topic-->dirt;
find-footstep-audio-for-each-topic-->gravel;
find-footstep-audio-for-each-topic-->sand;
find-footstep-audio-for-each-topic-->basal;
find-footstep-audio-for-each-topic-->stone;
find-footstep-audio-for-each-topic-->ancient-debris;
find-break-audio-for-each-topic-->wood;
find-break-audio-for-each-topic-->grass;
find-break-audio-for-each-topic-->dirt;
find-break-audio-for-each-topic-->gravel;
find-break-audio-for-each-topic-->sand;
find-break-audio-for-each-topic-->basal;
find-break-audio-for-each-topic-->stone;
find-break-audio-for-each-topic-->ancient-debris;
find-break-audio-for-each-topic-->adjust-pitch-&-volume;
find-footstep-audio-for-each-topic-->adjust-pitch-&-volume;
adjust-pitch&-volume-->play-test;
```
...
> - Minecraft Bedrock Edition <sup>( Windows, IOS or Android )</sup>
